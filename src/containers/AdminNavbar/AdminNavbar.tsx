...
type AdminNavbarUserLinkProps = {
  href: string;
  label: string;
};

const AdminNavbarUserLink = ({ href, label }: AdminNavbarUserLinkProps) => {
  return (
    <li>
      <Link
        href={href}
...
const AdminNavbarLink = ({ href, label }: AdminNavbarLinkProps) => {
  return (
    <li>
      <Link
        href={href}
        ...
        <div className="flex items-center md:order-2">
          ...
          >
            ...
            <ul className="py-1" aria-labelledby="user-menu-button">
              ...
              <AdminNavbarUserLink href="/admin/profile" label="Profile" />
              <AdminNavbarUserLink href="/auth/logout" label="Logout" />
